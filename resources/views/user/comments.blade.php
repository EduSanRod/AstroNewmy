...
<title>{{ Auth::user()->name; }} Comments</title>

<link rel="stylesheet" type="text/css" href="{{ asset('css/user/comments.css') }}" >
	...
	<div class="collapse navbar-collapse" id="navbarNavDropdown">
		<ul class="navbar-nav w-100 mx-auto">
			<li class="nav-item w-50 bg-light bg-gradient ">
				<a class="nav-link w-full d-flex justify-content-center" href="{{ route('user.articles') }}"><span class="h4 ">Articles</span></a>
			</li>
			<li class="nav-item active w-50 bg-dark bg-gradient">
				<a class="nav-link w-full d-flex justify-content-center" href="{{ route('user.comments') }}"><span class="h4 text-white">Comments</span></a>
			</li>
		</ul>
	</div>
</nav>
